...
alert('Sait ' + pisteet + ' pistetta, kun maksimi pistemaara oli ' + yhteensa);
tulokset.innerHTML = '<h3>Sait <span>' + pisteet +
'</span> pistetta, kun maksimi pistemaara oli <span>' +yhteensa + '</span></h3>';
return false;
